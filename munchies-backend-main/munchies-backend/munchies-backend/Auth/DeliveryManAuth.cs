...
namespace munchies_backend.Auth
{
    public class DeliveryManAuth : AuthorizationFilterAttribute
    {
        public override void OnAuthorization(HttpActionContext actionContext)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (exUser.userRole.Equals("deliveryMan") == false)
                    {
                        actionContext.Response = actionContext.Request.CreateResponse(
                            System.Net.HttpStatusCode.Forbidden,
                            new { Message = "Only DeliveryMan can access here" }
                        );
                    }
                }
            }
